...
PROTOBUF_NAMESPACE_OPEN
template<> ::main::Person* Arena::CreateMaybeMessage<::main::Person>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace main {
...
class Person PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:main.Person) */ {
 public:
...
inline const std::string& Person::name() const {
  // @@protoc_insertion_point(field_get:main.Person.name)
  return _internal_name();
}
inline void Person::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:main.Person.name)
}
inline std::string* Person::mutable_name() {
  // @@protoc_insertion_point(field_mutable:main.Person.name)
...
inline void Person::set_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:main.Person.name)
}
inline void Person::set_name(const char* value) {
  ...
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:main.Person.name)
}
inline void Person::set_name(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:main.Person.name)
}
...
inline std::string* Person::release_name() {
  // @@protoc_insertion_point(field_release:main.Person.name)
...
inline void Person::set_allocated_name(std::string* name) {
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:main.Person.name)
}
inline std::string* Person::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:main.Person.name)
...
inline void Person::unsafe_arena_set_allocated_name(
  ...
  name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:main.Person.name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Person::age() const {
  // @@protoc_insertion_point(field_get:main.Person.age)
...
inline void Person::set_age(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:main.Person.age)
}
